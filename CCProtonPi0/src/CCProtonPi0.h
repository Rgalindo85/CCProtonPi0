...
class CCProtonPi0 : public MinervaAnalysisTool
{
	...
	// Signal Definitiion Requirements
	...
	void GetBlobDirection(Minerva::PhysicsEvent *event, Minerva::IDBlob *blob) const;
        ...
        void getBestParticle(SmartRef<Minerva::Prong> prong, SmartRef<Minerva::Particle>& particle, Minerva::Particle::ID partType) const;
