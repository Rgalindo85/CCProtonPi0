...
${CMTROOT}/mgr/cmt setup -sh -pack=CCProtonPi0 -version=${MINERVA_RELEASE} -path=/minerva/app/users/rgalindo/cmtuser/Minerva_v10r8p7/Ana  -no_cleanup $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
